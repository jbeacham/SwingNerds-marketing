...
// 1200x630 branded card with the white logo on dark-navy background, plus
// tagline. Generated by scripts/generate-og-card.mjs. Used when a page
// doesn't set an explicit `image` on its meta. Renders cleanly on iMessage,
// Facebook, Twitter, LinkedIn, Slack, etc.
const DEFAULT_IMAGE = `${SITE_URL}/og-card-default.png`;
